        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div id="store" class="col-md-9">
                    <!-- add -->
					<form name="frmThemSP" action="quanLySP.php" method="post" enctype="multipart/form-data">
                    <div id="add" style="display: block;">
                        <div>
                            <p style="font-weight: 400; padding-left:15px; font-size: larger;">Thêm sản phẩm</p>
                            </br>
                        </div>
                        <!-- store top filter -->
                        ...
                        <div class="col-md-5" style="width:70%">
                            ...
                            <div class="billing-details">
                                ...
                                <div class="form-group">
                                    <input id="Tên sản phẩm" style="width:70%" class="input" type="text" name="txtTenSP" placeholder="Tên sản phẩm">
                                </div>
                                <div class="form-group">
                                    <input id="Giá sản phẩm" style="width:70%" class="input" type="text" name="txtGiaSP" placeholder="Giá sản phẩm">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input style="width:70%" class="input" type="text" name="txtCong_nghe" placeholder="Công nghệ">
                                </div>
                                <div class="form-group">
                                    <input style="width:70%" class="input" type="text" name="txtMan_hinh" placeholder="Màn hình">
                                </div>
                                <div class="form-group">
                                    <input style="width:70%" class="input" type="text" name="txtPGiai_manhinh" placeholder="Độ phân giải màn hình">
                                </div>
                                <div class="form-group">
                                    <input style="width:70%" class="input" type="text" name="txtPhan_giai" placeholder="Độ phân giải Camera">
                                </div>
                                <div class="form-group">
                                    <input style="width:70%" class="input" type="text" name="txtQuay_phim" placeholder="Quay phim">
                                </div>
                                ...
                                <!---->
                                <div class="form-group">
                                    <textarea name="txtMoTa" style="width: 455px; height: 167px;" class="input" rows="20" cols="100" placeholder="Mô tả"></textarea>
                                </div>
                                <div class="caption">
                                    <button type ="submit" style="width:150px" class="Dangky" name="btnThemSP">Thêm sản phẩm</button>
                                </div>
