...
function suaHUD() {
    ...
    tem = tem[1].split("&");
    ///////////////////////////
    var r = parseInt(tem[1]);
    var l = parseInt(tem[0]);
    switch (l) {
        ...
        case 1:
            {
                ...
                document.getElementById('product-modify').style.display = "block";
                ...
                // modify
                document.getElementById('hang').value = "0";
                document.getElementById("name").value = breadcrumb2[r];
                document.getElementById("gia").value = gia[r];

                document.getElementById("TSKT1").value = TSKT1[r];
                document.getElementById("TSKT2").value = TSKT2[r];
                document.getElementById("TSKT3").value = TSKT3[r];
                document.getElementById("TSKT4").value = TSKT4[r];
                document.getElementById("TSKT5").value = TSKT5[r];
                document.getElementById("TSKT6").value = TSKT6[r];
                document.getElementById("TSKT7").value = TSKT7[r];
                document.getElementById("TSKT8").value = TSKT8[r];
                document.getElementById("TSKT9").value = TSKT9[r];
                document.getElementById("TSKT10").value = TSKT10[r];
                document.getElementById("TSKT11").value = TSKT11[r];
                document.getElementById("TSKT12").value = TSKT12[r];
                document.getElementById("TSKT13").value = TSKT13[r];
                document.getElementById("TSKT14").value = TSKT14[r];
                document.getElementById("TSKT15").value = TSKT15[r];
                document.getElementById("TSKT16").value = TSKT16[r];
                document.getElementById("TSKT17").value = TSKT17[r];
                document.getElementById("TSKT18").value = TSKT18[r];
                document.getElementById("TSKT19").value = TSKT19[r];
                document.getElementById("TSKT20").value = TSKT20[r];
                document.getElementById("TSKT21").value = TSKT21[r];
                document.getElementById("TSKT22").value = TSKT22[r];
        ...
        case 2:
            {
                ...
                // modify
                document.getElementById('hang').value = "1";
                document.getElementById("name").value = breadcrumb2[r];
                document.getElementById("gia").value = gia[r];
        ...
        case 3:
            {
                ...
                // modify
                document.getElementById('hang').value = "2";
                document.getElementById("name").value = breadcrumb2[r];
                document.getElementById("gia").value = gia[r];
        ...
        case 4:
            {
                ...
                // modify
                document.getElementById('hang').value = "3";
                document.getElementById("name").value = breadcrumb2[r];
                document.getElementById("gia").value = gia[r];
...
function kiemtraSIZE(idText) {
    var inputText = document.getElementById(idText);
    var field = inputText.value;
    var thongbao = document.getElementById("saiadd");
    var thongbao2 = document.getElementById('saimod');

    var dem = 0;

    if (field == "") {      
        if (document.getElementById('add').style.display == "none") {
            thongbao2.innerHTML = "Tên sản phẩm không hợp lệ";
            $("#saimod").show();
            $("#saimod").delay(1000).fadeOut();
        } else {
            thongbao.innerHTML = idText + " không hợp lệ";
            $("#saiadd").show();
            $("#saiadd").delay(1000).fadeOut();
        }
        return false;
    } else
        return true;
...
function kiemtraGIA(idText) {
    ...
    if (field == "") {
        ...
        $("#saiadd").delay(1000).fadeOut();
        return false;
    } else if (inputText.value.split(' ').join('').match(numbers)) {
        if (parseInt(inputText.value.split(' ').join('')) < 0) {
            thongbao.innerHTML = idText + " không hợp lệ";
            $("#saiadd").show();
            $("#saiadd").delay(1000).fadeOut();
            return false;
...
function kiemtraGIA2(idText) {
    ...
    if (field == "") {
        thongbao2.innerHTML = "Giá sản phẩm không hợp lệ";
        $("#saimod").show();
        $("#saimod").delay(1000).fadeOut();
        return false;
    } else if (inputText.value.split(' ').join('').match(numbers)) {
...
function validation1() {
    if ((kiemtraSIZE('Tên sản phẩm')) && (kiemtraGIA('Giá sản phẩm'))) {
        alert("Thêm sản phẩm thành công");
    }
}

function validation2() {
    if ((kiemtraSIZE('name')) && (kiemtraGIA2('gia'))) {
    ...
    $(document).ready(function () {
        ...
        $("#nutdangnhap").click(function () {
            ...
            if (id.value == "admin" && mk.value == "admin") {
                window.location = "admin.html?1&0";
