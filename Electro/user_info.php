...
<?php
    ...
    $sql = sprintf("SELECT * FROM khach_hang WHERE username LIKE '%%%s%%'",$_SESSION['username']);
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div id="store" class="col-md-9">
                    ...
                    <div id="info">
                        <div>
                            <p style="font-weight: 400; padding-left:15px; font-size: larger;">Thông tin tài khoản</p>
                            </br>
                        </div>
                        <!-- store top filter -->
                        <div class="col-md-7" style="width:17%">
                            <!-- Billing Details -->
                            <div class="billing-details">
                                <div class="form-group">
                                    <input style="border: 0px solid #E4E7ED; padding: 0px 0px" value="Họ" class="input" type="text" name="first-name">
                                </div>
                                <div class="form-group">
                                    <input style="border: 0px solid #E4E7ED; padding: 0px 0px" value="Tên" class="input" type="text" name="first-name">
                                </div>
                                <div class="form-group">
                                    <input style="border: 0px solid #E4E7ED; padding: 0px 0px" value="Số điện thoại" class="input" type="text" name="last-name">
                                </div>
                                <div class="form-group">
                                    <input style="border: 0px solid #E4E7ED; padding: 0px 0px" value="Email" class="input" type="email" name="email">
                                </div>
                                <div class="form-group">
                                    <input style="border: 0px solid #E4E7ED; padding: 0px 0px" value="Địa chỉ" class="input" type="text" name="address">
                                </div>
                            </div>
                            <!-- /Billing Details -->
                        </div>
                        ...
                        <form action="quanlyUser.php">
                            <!-- Billing Details -->
                            <div class="billing-details">
                                <div class="form-group">
                                    <input class="input" type="text" name="update_ho" value="<?=$row['ho'];?>" >
                                </div>
                                <div class="form-group">
                                    <input class="input" type="text" name="update_ten" value="<?=$row['ten'];?>" >
                                </div>
                                <div class="form-group">
                                    <input class="input" type="text" name="update_sdt" value="<?=$row['sdt'];?>">
                                </div>
                                <div class="form-group">
                                    <input class="input" type="email" name="update_email" value="<?=$row['email'];?>">
                                </div>
                                <div class="form-group">
                                    <input class="input" type="text" name="update_address" value="<?=$row['dia_chi'];?>">
                                </div>
                                <div class="caption">
                                    <button id="nutdangky" class="Dangky">Cập nhật</button>
                                </div>
                            </div>
                            <!-- /Billing Details -->
                        </form>
